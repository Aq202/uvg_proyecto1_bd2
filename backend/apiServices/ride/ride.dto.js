...
const createRideDto = (resource) => {
    var _a, _b, _c;
    const { startLocation, arrivalLocation, user, passengers, completed, datetime, vehicle, isPassenger, } = (_a = resource === null || resource === void 0 ? void 0 : resource._doc) !== null && _a !== void 0 ? _a : resource;
    return {
