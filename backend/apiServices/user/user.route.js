...
import { createUserController, getSessionUserController, getUserImageController, loginController, updateUserController, uploadUserImageController, } from "./user.controller.js";
...
userRouter.post("/image", ensureAuth, multerMiddleware(uploadImage.single("photo")), uploadUserImageController);
